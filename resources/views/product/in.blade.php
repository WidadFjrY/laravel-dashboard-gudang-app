    ...
    <div style="background-color: white; position: relative; top: -6rem" class="m-3 p-3 rounded-2 shadow-sm">
        ...
        @if ($products->total() != 0)
                    ...
                    @foreach ($products as $product)
                        <tr>
                            ...
                            <td class="text-center">
                                <button type="button" class="btn btn-success btn-modal-stock" data-toggle="modal"
                                    data-target="#modalStock" data-product-id="{{ $product['id'] }}"
            ...
            <div class="d-flex justify-content-between align-items-center">
                <a href="/product/create" class="btn btn-success">Tambah Product</a>
                {{ $products->links() }}
            </div>
            @include('partials.modal-stock')
        @else
            <a href="/product/create" class="btn btn-success mt-2">Tambah Product</a>
